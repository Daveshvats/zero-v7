...
- **Fixed Ban Plugin** - Corrected JID field usage and added LID-to-JID resolution to ensure ban/unban uses the same JID format as permission checks. Added `banned` column to groups schema
