...
export default {
        ...
        execute: async (m, { text, sock }) => {
                ...
                if (mediaType && mediaBuffer) {
                        // TODO: Media hidetag is broken — extendedTextMessage does not support media.
                        // Fix requires using generateWAMessageFromContent with the appropriate message type
                        // (e.g. imageMessage, videoMessage) instead of extendedTextMessage.
